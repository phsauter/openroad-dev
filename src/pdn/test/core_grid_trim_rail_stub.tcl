# test for trimming followpin rail stubs after terminal ring vias
source "helpers.tcl"
...
set def_file [make_result_file core_grid_trim_rail_stub.def]
write_def $def_file
diff_files core_grid_trim_rail_stub.defok $def_file
